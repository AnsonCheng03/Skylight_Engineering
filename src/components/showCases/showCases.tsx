...
export default component$(({ photos, type, name }: any) => {
  ...
  const copyLink = $((type: any, name: any) => {
    ...
    sharingButton.classList.add("active");
    setTimeout(() => {
      sharingButton.classList.remove("active");
    }, 2000);
  });
